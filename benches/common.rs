...
pub fn earlygame_board() -> Board {
    Board::from_fen(EARLYGAME_FEN).unwrap()
}

pub fn midgame_board() -> Board {
    Board::from_fen(MIDGAME_FEN).unwrap()
}

pub fn lategame_board() -> Board {
    Board::from_fen(LATEGAME_FEN).unwrap()
}
